...
#print("Shadowed_length and rim temp ",shadowed_length/AU,innerHole(R_rim))
...
ax.axvline(R_rim/AU,ls=':', label='R_{rim}')
ax.axvline(R_rim/AU +shadowed_length/AU,ls=':',label='$R_{flare}$')
...
fig, ax = plt.subplots()
ax.semilogx(R/AU, h_cg/R,ls='--',label ='H_p/R')
ax.semilogx(R/AU, H_cg/R,marker = '*', markevery = (Q_stability <1), label ='H_s/R')
ax.axvline(R_rim/AU,ls=':', label='R_{rim}')
ax.axvline(R_rim/AU +shadowed_length/AU,ls=':',label='$R_{flare}$')
ax.set_xlabel("R")
...
fig, ax = plt.subplots()
ax.plot(R/AU, H_cg,ls='--',label ='H_s/R')
ax.set_xlabel("R")
ax.set_ylabel("$H_{p}/R  ............ H_{S}/R $")
...
ax.semilogx(R/AU, gas_density(R_hole) ,marker = '*', markevery = (Q_stability <1))
ax.set_xlabel("Radius")
