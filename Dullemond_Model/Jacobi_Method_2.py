...
def iterative_newton(fun, x_init, jacobian):
    ...
    for k in range(max_iter):
        ...
        print("Hello I am J:",J)
        F = np.array(fun(x_last))
        print("Hello I am FFFFFF:",F,"\n\n\n")
        diff, resid, rank, s = np.linalg.lstsq(J, -F)
        x_last = x_last + diff
...
X_guess_rim =(np.array( [0.539*AU, 0.019*AU,0.09344*AU,1.52,5000], dtype =float))
