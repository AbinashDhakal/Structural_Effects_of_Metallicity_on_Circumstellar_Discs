...
print(Metallicity, R_rim/AU,H_rim/AU,gray_const)
...
for i in range(len(R)):
    kp_Tgas[i],Rho_gas[i], Tgas[i] =innerHole(R[i],Metallicity, T_stellar)

fig, ax = plt.subplots()
ax.semilogx(R/AU, Rho_gas)
...
#-0.3 0.3902397108364166 0.0472852566205298 0.6094622727046433
#0 0.2985923318313027 0.03203487233899535 0.3612903307835867
#0.3 0.17374069643556533 0.014560104953319483 0.12497328556829979